      ...
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 10.0,),
            Text("anda baru saja mengupgdate aplikasi",textAlign: TextAlign.center,style:TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Rubik')),
            Text("tekan tombol keluar untuk melanjutkan proses pemakaian aplikasi",textAlign: TextAlign.center,style:TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Rubik')),
          ],
        ),
      ),
    );
